...
const HARD_CODED_ZONE_SHEET_MAPPING: Array<[string, string]> = [
  ...
  ["PORTA A MARE", "VALENTINA"],
  ["PORTA FIORENTINA", "AG-PISA"],
  ["PORTA NUOVA", "MATTIA"],
  ["PRATALE", "GIUSEPPE"],
  ["PUTIGNANO", "AG-PISA"],
  ["RIGLIONE", "AG-PISA"],
  ...
  ["Pardossi", "REBECCA"],
  ["Capannoli", "PATRIZIA"],
  ["San Pietro Belvedere", "PATRIZIA"],
  ["Santo Pietro Belvedere", "PATRIZIA"],
  ["Solaia", "PATRIZIA"],
  ["Casale Marittimo", "AG-PISA"],
  ["Casciana Terme Lari", "FAUSTO"],
  ["Boschi di Lari", "FAUSTO"],
  ["Casciana Alta", "FAUSTO"],
  ["Casciana Terme", "FAUSTO"],
  ["Cevoli", "FAUSTO"],
  ["Colle Montanino", "FAUSTO"],
  ["La Capannina", "FAUSTO"],
  ["Lari", "FAUSTO"],
  ["Lavaiano", "FAUSTO"],
  ["Parlascio", "FAUSTO"],
  ["Perignano", "FAUSTO"],
  ["Quattro strade", "FAUSTO"],
  ["San Ruffino", "FAUSTO"],
  ["Sant'Ermo", "FAUSTO"],
  ["Usigliano", "FAUSTO"],
  ["Cascina", "TOMMASO"],
  ...
  ["Chianni", "AG-PISA"],
  ["Crespina Lorenzana", "FAUSTO"],
  ["Belvedere", "FAUSTO"],
  ["Botteghino", "FAUSTO"],
  ["Cenaia", "FAUSTO"],
  ["Cenaia Vecchia", "FAUSTO"],
  ["Ceppaiano", "FAUSTO"],
  ["Colle Alberti", "FAUSTO"],
  ["Crespina", "FAUSTO"],
  ["Fungiaia", "FAUSTO"],
  ["I Gioielli", "FAUSTO"],
  ["II Colle", "FAUSTO"],
